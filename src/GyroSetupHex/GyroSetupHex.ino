...
void gyro_signals(void) {
  ...
  int16_t GyroX= (int16_t)(Wire.read() << 8 | Wire.read()) / 16384.0;
  int16_t GyroY= (int16_t)(Wire.read() << 8 | Wire.read()) / 16384.0;
  int16_t GyroZ= (int16_t)(Wire.read() << 8 | Wire.read()) / 16384.0;
